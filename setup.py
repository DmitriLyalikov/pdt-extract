...
setup(
    ...
    long_description="This package provides modules and automation to perform edge profile extraction and "
                     "characteristic feature approximation from pendant drop images.",
